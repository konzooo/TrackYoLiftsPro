...
import { INITIAL_WORKOUTS, INITIAL_EXERCISE_REPO, PREDEFINED_TAGS } from './constants';
...
const App: React.FC = () => {
  ...
  const [exerciseRepository, setExerciseRepository] = useState<RepoExercise[]>(() => safeParse('exercise_repo', INITIAL_EXERCISE_REPO));
...
// --- Persistence & Data Handling ---
  ...
  const resetToPlan = useCallback(() => {
    ...
    setExerciseRepository(INITIAL_EXERCISE_REPO);
